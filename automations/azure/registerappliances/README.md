...
This Azure Function App registers appliances with cClear-V.
It responds to Event Grid System Topic events by issuing HTTP requests to cClear-V and cVu-V.

Below is the generated documentation from the Azure Function core tools.
